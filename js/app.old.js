;(function() {
    ...
    mmhApp.controller('test', ['$scope', 'dialogs', 'dataProvider', function($scope, dialogs, dataProvider) {
        $scope.message = 'HELLO!';
        ...
        $scope.showPlaces = function() {
            ...
            dialog.result.then(function(places) {
                console.log('Show places result:', places);
            });
        }
        ...
        var timesProvider = {
            getTimes: function() {
                return [
                    moment('2015-08-14 09:00:00'),
                    moment('2015-08-14 09:30:00'),
                    moment('2015-08-14 13:00:00')
                ];
            },
        ...
        $scope.showTimes = function() {
            ...
            dialog.result.then(function(times) {
                console.log('Show times result:', times);
            });
        }
        
        $scope.showUserInfo = function() {
            var dialog = dialogs.meetingUserInfo({});
        }
    }]);
